...
- Resuming your work...
  - [course_upstream repo][course_upstream]
...
- [ ] preparations to resume your work
  ...
  - [ ] *(optional, but recommended)* prepare a script (e.g., `<STUDENT_REPO_ROOT>/scripts/deploy_images`) to deploy the files needed to boot the PYNQ board on the memory card
    - Required files: uImage, u-boot.img, boot.bin, core-image-minimal-pynq.cpio.gz.u-boot, uEnv.txt, devicetree.dtb
...
[meta-pynq]: https://moodle.tuni.fi/course/view.php?id=17828
